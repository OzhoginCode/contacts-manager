...
Требует аутентификации (активной сессии)
HTTP Статусы:
...
Полностью идемпотентен: удаляет сессию вне зависимости от того, существует ли текущая
HTTP Статусы:
...
Вместо :id подставить id нужного аккаунта
HTTP Статусы:
* 204 No Content - при успешном удалении
* 401 Unauthorized - если пользователь не аутентифицирован
* 404 Not Found - если аккаунт не найден
